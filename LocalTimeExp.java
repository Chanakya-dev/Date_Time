...
// : Write a method addHoursToTime(LocalTime time, int hours) that takes a LocalTime object and an integer representing hours, 
//and returns a new LocalTime with the specified number of hours added.
