...
// Write a method getCurrentDateTime() that returns the current date and time as a LocalDateTime object. 
// Also, print the date-time in the format yyyy-MM-dd HH:mm:ss.
  //  Write a method isDateTimeBefore(LocalDateTime dateTime1, LocalDateTime dateTime2) that takes 
  // two LocalDateTime objects and returns true if dateTime1 is before dateTime2, otherwise returns false.
  ...
  public static void main(String[] args) {
    ...
    LocalDate lDateTime = lDateTimeExp.getCurrentDateTime();
